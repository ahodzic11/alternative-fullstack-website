  ...
  return (
    <>
      ...
      <div className="historijatContainer">
        <div className="workshopsMainTitle">Historijat</div>
        <div className="timeline">
          ...
          <div className="containersss left">
            <div className="content-item">
              ...
              <div className="content-text">
                ...
                <div className="content-row">
                  Iz ovog perioda aktivistkinje udruženja (Forum žena „Alternative“ Kakanj) nose tužna sjećanja na prijetnje organiziranih grupa ljudi iz Kaknja i Vareša smještenih u Drvaru, da će biti kamenovane ako tamo dođu govoriti o povratku. Nisu zaboravljene ni pogrdne riječi i pljuvanje aktivistica od strane nekolicine kakanjki smještenih u izbjegličkom kampu Tasovčići, a ni otpor tadašnje
                  lokalne i drugih nivoa vlada prema povratku.{" "}
                </div>
                <div className="content-row">
          ...
          <div className="containersss left">
            <div className="content-item">
              ...
              <div className="content-text">
                ...
                <div className="content-row">
                  Period poslije 2000. godine karaterišu projekti građanskih inicijativa i aktivnosti usmjerene na ohrabrenje građana za učešće u procesu donošenja odluka na lokalnom nivou i preuzimanje odgovornosti u planiranju i razvoju zajednice. Paralelno s tim udruženje kontinuirano radi na uspostavljanju i unapređenju suradnje sa lokalnim vladama u području unapređenja komunikacije i uvjeta
                  za učešće građana u procesima odlučivanja. U planiranju projekata „Alternative“ se oslanjanju na istraživanja u zajednici i participaciju građana te vode računa o elementima održivog razvoja.
                </div>
          ...
          <div className="containersss right">
            <div className="content-item">
              <div className="content-headline">
                <h2>2014-2018</h2>
                <p>PROMOCIJA UĆEŠĆA ŽENA U POLITICI I EKOLOGIJA</p>
              </div>
              <div className="content-text">
